...
//                                                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    if (dataSnapshot.child("type").getValue(String.class) != null && dataSnapshot.child("type").getValue(String.class).equals("User")) {
                                                        progressBar.setVisibility(View.GONE);
                                                        Intent intent = new Intent(LoginActivity.this, UserRestaurantActivity.class);
                                                        startActivity(intent);
                                                    } else if(dataSnapshot.child("type").getValue(String.class) != null && dataSnapshot.child("type").getValue(String.class).equals("Admin")){
                                                        progressBar.setVisibility(View.GONE);
