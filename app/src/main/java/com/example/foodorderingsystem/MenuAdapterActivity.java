...
public class MenuAdapterActivity extends RecyclerView.Adapter<MenuAdapterActivity.MyViewHolder> {
    ...
    public MenuAdapterActivity(Activity activity,ArrayList<Food> data,int showbutton, ArrayList<String> key) {
    ...
    @Override
    public MenuAdapterActivity.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                     int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_menu_adapter, parent, false);

        MenuAdapterActivity.MyViewHolder myViewHolder = new MenuAdapterActivity.MyViewHolder(view);
        return myViewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(MenuAdapterActivity.MyViewHolder holder, final int listPosition) {
    ...
    class getAndSetImage extends AsyncTask<String,Void,Void> {
       ...
       Food recentHistory;
        ...
        public getAndSetImage(String url, final MenuAdapterActivity.MyViewHolder holder, Food recentHistory){
            urlString = url;
        ...
        protected void onPostExecute(Void aVoid) {
           ...
           MenuAdapterActivity.this.notifyDataSetChanged();
            if(bmp!=null) {
